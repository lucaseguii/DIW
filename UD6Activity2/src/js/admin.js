    ...
    adminContainer.append(`
        ...
        <div class="secadminpage">
            ...
            <section id="user-management">
                ...
                <button id="add-user"><a href="/DIW/UD6Activity2/src/views/afegirusuari.html">Afegir Usuari</a></button>
            ...
            <section id="news-management">
                ...
                <button id="add-news"><a href="/DIW/UD6Activity2/src/views/afegirnoticies.html">Afegir Notícia</a></button>
            ...
            <section id="bone-files-management">
                ...
                <button id="add-file"><a href="/DIW/UD6Activity2/src/views/afegirfitxes.html">Afegir Fitxa</a></button>
